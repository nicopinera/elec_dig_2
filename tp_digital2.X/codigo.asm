...
TEMPREF     EQU 0X21    ;TEMPERATURA DE REFERENCIA
WTEMP   EQU 0X70
STATUST EQU 0X71
...
MAIN:
    ...
    MOVWF       TRISD
    MOVLW       B'00000001' ;RB0 ENTRRADA DEL PULSADOR - RB1 Y RB2 SALIDAS A LOS Q
    MOVWF       TRISB
...
MAIN_LOOP:  ;LOOP PRINCIPAL
    BTFSS   INGRESAR,0  ;SI ESTA EN 0 NO ESPERO UNA TECLA, SI ESTA EN 1 SI
    GOTO    MAIN_LOOP
    CALL    TECLADO
